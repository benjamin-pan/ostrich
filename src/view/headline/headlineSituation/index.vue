            ...
            <div class="news-list-left">
              <div class="tuoniao-ency">
                <span class="tuoniao-ency-img" style="background: #409EFF;">
                  <img style="margin-left: 3px;" src="../../../assets/images/thought.png">
                </span>
                <span class="tuoniao-see">观点洞察</span>
              </div>
              <!-- 置顶新闻 -->
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h4 class="media-heading">
                        <a @click="$router.push({path: '/headline/headlineDetails'})" class="tuoniao-a">好消息频出！这是利好被提前释放还是牛市苗头的初现</a>
                      </h4>
